const IMAGE_TOOLS = [
  {
    name:"Adobe Firefly",
    bestFor:"Commercial creative workflows, image generation and Adobe ecosystem",
    pricing:"Free access available; paid Firefly plans available",
    free:true,
    description:"Adobe's generative AI platform for creating and editing images, video and other creative assets.",
  ...
  {
    name:"Canva AI",
    bestFor:"Social graphics, presentations, marketing visuals and quick design",
    pricing:"Free plan available; Pro and other paid plans available",
    free:true,
    description:"AI-assisted design features integrated into Canva's visual creation platform.",
  ...
  {
    name:"Leonardo AI",
    bestFor:"Image generation, creative assets and visual experimentation",
    pricing:"Free access available; paid plans available",
    free:true,
    description:"A generative AI platform focused on image creation, editing and production workflows.",
  ...
  {
    name:"Midjourney",
    bestFor:"High-quality artistic images, concept art and visual exploration",
    pricing:"Basic $10/month; Standard $30/month; Pro $60/month; Mega $120/month",
    free:false,
    description:"A subscription-based image and video generation platform known for artistic and highly stylized visual results.",
  ...
  {
    name:"Ideogram",
    bestFor:"Posters, logos, typography and images containing readable text",
    pricing:"Free plan available; Plus $20/month monthly or $15/month annual billing",
    free:true,
    description:"A generative image platform with a strong focus on text rendering, design and production workflows.",
  ...
  {
    name:"Recraft",
    bestFor:"Brand graphics, vectors, illustrations and production design",
    pricing:"Free/paid access varies; verify current pricing",
    free:true,
    description:"A creative generation platform focused on production-ready images, vectors and design assets.",
  ...
  {
    name:"Flux",
    bestFor:"Advanced text-to-image generation and model experimentation",
    pricing:"Access and pricing vary by provider and deployment",
    free:true,
    description:"A family of image-generation models available through different hosted and developer platforms.",
  ...
  {
    name:"Playground",
    bestFor:"AI image creation, editing and rapid visual experimentation",
    pricing:"Free/paid availability varies; verify current pricing",
    free:true,
    description:"An AI visual creation platform for generating and editing images and creative assets.",
  ...
  },
  {
    ...
    bestFor:"Quick social posts, invitations, graphics and AI-assisted design",
    pricing:"Free access available; limits and premium features vary",
    free:true,
    description:"Microsoft's AI-assisted design experience for generating and editing visual content.",
  ...
  {
    name:"DreamStudio",
    bestFor:"Generative image creation with Stability AI models",
    pricing:"Usage-based access; verify current pricing",
    free:false,
    description:"A web interface for generating images with Stability AI technology.",
