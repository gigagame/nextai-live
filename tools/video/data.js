const VIDEO_TOOLS = [
  {
    name:"Runway",
    bestFor:"Professional AI video generation, editing and creative production",
    pricing:"Free plan with one-time credits; paid plans available",
    free:true,
    description:"AI creative platform for generating and editing video, images and other media with a broad model ecosystem.",
  ...
  {
    name:"Kling AI",
    bestFor:"Text-to-video, image-to-video and cinematic AI generation",
    pricing:"Free access and paid credit/subscription options vary by current offer",
    free:true,
    description:"Generative AI platform focused on creating and transforming video from text and images.",
  ...
  {
    name:"Pika",
    bestFor:"Fast creative video effects, image-to-video and social content",
    pricing:"Free/paid access available; verify current credits and plans",
    free:true,
    description:"AI video creation platform focused on accessible generation, effects and creative transformations.",
  ...
  },
  {
    ...
    bestFor:"High-quality generative video, image-to-video and cinematic concepts",
    pricing:"Free tier available; Lite $9.99/month, Plus $29.99/month and Unlimited $94.99/month on web",
    free:true,
    description:"Luma's generative media platform for creating images and videos with its Dream Machine models.",
  ...
  {
    name:"Google Veo",
    bestFor:"High-quality generative video and advanced text-to-video workflows",
    pricing:"Availability and pricing depend on the Google product or API used",
    free:true,
    description:"Google's family of generative video models available through selected Google products and developer services.",
  ...
  },
  {
    ...
    bestFor:"Commercial creative workflows, video generation and Adobe production",
    pricing:"Free access may be available; paid Firefly plans provide additional generative capacity",
    free:true,
    description:"Adobe's generative AI ecosystem includes video generation and creative production tools.",
  ...
  {
    name:"HeyGen",
    bestFor:"AI avatars, presenter videos, localization and business communication",
    pricing:"Free/paid plans available; verify current limits and pricing",
    free:true,
    description:"AI video platform focused on avatars, presenters, translation and business video creation.",
  ...
  {
    name:"Synthesia",
    bestFor:"Corporate training, learning, presentations and AI avatar videos",
    pricing:"Free/demo access varies; paid plans available",
    free:true,
    description:"AI video platform designed around digital presenters, business communication and training content.",
  ...
  {
    name:"CapCut",
    bestFor:"Short-form social video editing, templates, captions and AI-assisted creation",
    pricing:"Free plan available; Pro features available",
    free:true,
    description:"Popular video editing platform with AI-assisted creation, templates, captions and social-first workflows.",
    ...
    url:"https://www.capcut.com/",logo:"https://www.google.com/s2/favicons?domain=capcut.com&sz=128"
  },
  {
    name:"InVideo AI",
    bestFor:"Prompt-to-video, marketing videos, social content and rapid production",
    pricing:"Free access available with paid plans and usage limits",
    free:true,
    description:"AI-assisted video creation platform for turning prompts and ideas into edited videos.",
